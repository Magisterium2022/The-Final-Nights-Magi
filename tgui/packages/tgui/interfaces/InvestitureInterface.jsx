...
export const InvestitureInterface = (props) => {
  const { act, data } = useBackend();

  const inventory = data.product_records || [];

  const getGreeting = () => {
    if (data.user?.has_daimonion){
      return "Welcome, student of the Sleepers";
    } else {
      return "You seek forbidden knowledge...";
    }
  };
