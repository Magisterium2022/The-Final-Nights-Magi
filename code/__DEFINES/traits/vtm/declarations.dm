...
#define TRAIT_DEVIL_EYE_OPEN	"devil_eye_open" //This is for Devil Eyes (Baali) Stuff in regards to oepning and closing it
#define TRAIT_DEVIL_EYE		"devil_eye" //This is for when you want to like actually know if you have the eye or not
