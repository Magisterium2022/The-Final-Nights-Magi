...
GLOBAL_LIST_INIT(traits_by_type, list(
	/mob = list(
		...
		"TRAIT_FAIR_GLABRO" = TRAIT_FAIR_GLABRO,
		...
		"TRAIT_PERFECT_DEFENCE" = TRAIT_PERFECT_DEFENCE,
		"TRAIT_WALLBREAKER" = TRAIT_WALLBREAKER,
		"TRAIT_ANIMAL_SUCCULENCE" = TRAIT_ANIMAL_SUCCULENCE,
		"TRAIT_QUIETUS_CURSED" = TRAIT_QUIETUS_CURSED,
		"TRAIT_QUICKEN_MORTAL_BLOOD" = TRAIT_QUICKEN_MORTAL_BLOOD,
		"TRAIT_CURRENTLY_TRANSFORMING" = TRAIT_CURRENTLY_TRANSFORMING,
		"TRAIT_DEVIL_EYE_OPEN" = TRAIT_DEVIL_EYE_OPEN,
		"TRAIT_DEVIL_EYE" = TRAIT_DEVIL_EYE,
	),
